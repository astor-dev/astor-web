...
import FloatingIcons from "~features/about/components/hero/floating-icons";
        ...
        <div id="hero-overlay" className={overlayVisible ? "" : "hidden"}>
          ...
          <div className="relative z-20 mx-auto flex flex-col items-center space-y-6 px-4 text-center">
            <div
              ...
              className="relative block w-full whitespace-normal break-words rounded-lg p-4 text-center font-code text-3xl text-white-accent md:text-4xl lg:text-5xl"
            >
