...
<img
  height="365"
  width="376"
  alt="메모리] JVM의 메모리 사용 방식 : JVM의 Static Area와 Heap Area를 중심으로 Kotlin/JVM의 메모리  사용방식을 이해하기 — 조세영의 Kotlin World"
  src="https://blog.kakaocdn.net/dna/bIO6Ne/btqWn2vhjds/AAAAAAAAAAAAAAAAAAAAALzb6FJ5i_vozrQcdsOplrwyqh-Prj52iEisPljvPuHq/img.png?credential=yqXZFxpELC7KVnFOS48ylbz2pIh7yKj8&expires=1753973999&allow_ip=&allow_referer=&signature=Il9US7pwKpbWjLEN9aYVYN%2FeG%2Bk%3D"
/>
