...
주석을 보면 Impl class에서 실질적 동작을 처리하고 있다고 하는데, 이것은 Socket 클래스가 SocketImpl 인터페이스를 implements 한 것이 아니고 **브릿지(Bridge) 디자인 패턴**의 한 형태로 구현된 것입니다.
...
![](https://d2r0pavv0lsiqc.cloudfront.net/projects/images/1f4f681d-19cb-476b-ae1e-bbf72ea4f12c.webp)

![](https://d2r0pavv0lsiqc.cloudfront.net/projects/images/9854e05c-5456-4c3d-98df-a4e701d0ce43.webp)

![](https://d2r0pavv0lsiqc.cloudfront.net/projects/images/910ad0e3-6d4c-4e81-97ba-58984407e111.webp)

노출된 public 생성자를 보면 로컬 주소 바인드 로직도 보입니다. 여기서 주소에 해당하는 건 로컬 IP로 보통 NIC까지 세밀하게 제어를 하지 않으니 빈 값을 줍니다.

![](https://d2r0pavv0lsiqc.cloudfront.net/projects/images/19bd1d2b-a1eb-4dfe-8e35-4b3df301ff4f.webp)

![](https://d2r0pavv0lsiqc.cloudfront.net/projects/images/48f01cab-bc5b-4056-92d5-bf0c97018413.webp)

![](https://d2r0pavv0lsiqc.cloudfront.net/projects/images/c9b34350-6779-4092-9f5f-cc2ee223ea44.webp)

![](https://d2r0pavv0lsiqc.cloudfront.net/projects/images/c873c5e7-7d62-40cf-b0a5-579206b48216.webp)

![](https://d2r0pavv0lsiqc.cloudfront.net/projects/images/cff253e9-cca1-41a3-90f9-16bb49d95a77.webp)

최종적으로 JNI를 통해 C++로 실제 SocketAPI의 `bind()`를 호출합니다. 로컬 포트가 없다면 여기서 시스템콜로 받아옵니다.

JNI가 무엇인지나 Java에서 어떻게 시스템콜까지 닿는 지는 [Java의 new Thread()는 어떻게 OS 커널 스레드가 될까?](https://github.com/search?q=repo%3Aopenjdk%2Fjdk%20bind0\&type=code) 이 글에서 한번 자세히 다뤄서 생략하겠습니다.
...
타고타고 가면 나오는 native accept의 Unix 쪽 구현체입니다. Socket API accept함수를 호출하고 있고, 앞서 살펴 봤듯 native socket api의 accept 함수 블로킹 함수여서 결국 자바에서 accept를 호출하면 현재 스레드를 블로킹합니다.
