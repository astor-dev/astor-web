...
```ts
@Module({
  imports: [PaymentProcessingModule, PromotionModule, LeaderElectionModule, CachingModule],
...
@Module({
  ...
  providers: [PaymentFacade, ...paymentOrigins, PaymentOriginFactory, DiscountManager],
